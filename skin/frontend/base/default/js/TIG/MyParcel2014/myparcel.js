...
(function() {
    ...
    fetchDeliveryOptions = function(postal_code, number, street) {
        ...
        jQuery('.mypa-location').html(street + " " + number);
        options = {
            url: urlBase,
            data: {
                cc: NATIONAL,
    ...
    renderDays = function(deliveryDays) {
        ...
        jQuery('.mypa-tab').bind('click', updateDelivery);
        jQuery('.mypa-tab')[0].click();
    ...
    updateDelivery = function(e) {
        ...
        date = jQuery("#" + (jQuery(e.currentTarget).prop('for')))[0].value;
        jQuery('#mypa-delivery-options').html('');
        html = '';
        ...
        return jQuery('#mypa-delivery-options').html(html);
    };
