 ...
 */
class TIG_MyParcelBE_Block_Adminhtml_System_Config_SupportTab
    ...
    implements Varien_Data_Form_Element_Renderer_Interface
{
     ...
     */
    const SYSTEM_CONFIG_EDIT_CSS_FILE = 'css/TIG/MyParcelBE/system_config_edit_myparcel.css';
    const MAGENTO_16_CSS_FILE         = 'css/TIG/MyParcelBE/system_config_edit_myparcel_magento16.css';

    /**
     * @var string
     */
    protected $_template = 'TIG/MyParcelBE/system/config/supportTab.phtml';
