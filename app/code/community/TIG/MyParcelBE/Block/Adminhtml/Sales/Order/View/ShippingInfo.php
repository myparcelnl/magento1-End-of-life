 ...
 */
class TIG_MyParcelBE_Block_Adminhtml_Sales_Order_View_ShippingInfo extends Mage_Adminhtml_Block_Abstract
{
    /**
     * @var Mage_Sales_Model_Order|TIG_MyParcelBE_Model_Sales_Order
     */
    protected $_order;
    ...
    {
        $optionsHtml = '';
        /** @var $myParcelShipment TIG_MyParcelBE_Model_Shipment */
