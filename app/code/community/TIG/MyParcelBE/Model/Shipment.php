 ...
 * @method TIG_MyParcelBE_Model_Shipment setTrackId(int $value)
 * @method TIG_MyParcelBE_Model_Shipment setConsignmentId(int $value)
 * @method TIG_MyParcelBE_Model_Shipment setCreatedAt(string $value)
 * @method TIG_MyParcelBE_Model_Shipment setUpdatedAt(string $value)
 * @method TIG_MyParcelBE_Model_Shipment setStatus(string $value)
 * @method TIG_MyParcelBE_Model_Shipment setBarcode(string $value)
 * @method TIG_MyParcelBE_Model_Shipment setIsFinal(int $value)
 * @method TIG_MyParcelBE_Model_Shipment setShipment(Mage_Sales_Model_Order_Shipment $value)
 * @method TIG_MyParcelBE_Model_Shipment setOrder(Mage_Sales_Model_Order $value)
 * @method TIG_MyParcelBE_Model_Shipment setShippingAddress(Mage_Sales_Model_Order_Address $value)
 * @method TIG_MyParcelBE_Model_Shipment setApi(TIG_MyParcelBE_Model_Api_MyParcel $value)
 * @method TIG_MyParcelBE_Model_Shipment setShipmentIncrementId(string $value)
 * @method TIG_MyParcelBE_Model_Shipment setBarcodeSend(int $value)
 * @method TIG_MyParcelBE_Model_Shipment setRetourlink(string $value)
