 ...
 *
 * @method TIG_MyParcelBE_Model_Adminhtml_Observer_OrderGrid   setCollection(TIG_MyParcelBE_Model_Resource_Order_Grid_Collection $value)
 * @method TIG_MyParcelBE_Model_Resource_Order_Grid_Collection getCollection()
 * @method TIG_MyParcelBE_Model_Adminhtml_Observer_OrderGrid   setBlock(Mage_Adminhtml_Block_Sales_Order_Grid $value)
 * @method Mage_Adminhtml_Block_Sales_Order_Grid                 getBlock()
 */
class TIG_MyParcelBE_Model_Adminhtml_Observer_OrderGrid extends Varien_Object
{
    /**
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($field && isset($cond)) {
            /**
             * @var TIG_MyParcelBE_Model_Resource_Order_Grid_Collection $collection
             */
